        ...
        useCallback(() => {
            ...
            const fetchData = async () => {
                ...
                try {
                    ...
                    if (isMounted) setIsPedometerAvailable(true);
