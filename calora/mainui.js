        ...
        <TouchableOpacity style={styles.smallCard(theme)} onPress={onPress}>
            <View style={styles.smallCardHeader(isRTL)}>
                <View style={[styles.smallCardIconContainer(theme)]}>
                    <MaterialCommunityIcons name="run-fast" size={20} color={theme.primary} />
                </View>
                <Text style={styles.smallCardTitle(theme)}>{t('workouts')}</Text>
            </View>
            <View style={styles.smallCardContent(isRTL)}>
                <Text style={styles.smallCardValue(theme, isRTL)}>
                    {totalCaloriesBurned > 0 ? `🔥 ${Math.round(totalCaloriesBurned)}` : t('not_logged')}
                </Text>
                {totalCaloriesBurned > 0 && 
                    <Text style={styles.smallCardSubValue(theme, isRTL)}>{t('burned_cal')}</Text>
                }
            </View>
        </TouchableOpacity>
    );
